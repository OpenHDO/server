      ...
      <header className="flex items-center gap-3 px-3 py-3 min-[390px]:px-4">
        ...
        <div className="flex shrink-0 items-center gap-1">
          <div className="hidden items-center gap-2 px-1 text-neutral-300 min-[390px]:flex">
            ...
            {linker.transports.filter((transport) => transport !== "wifi").map((transport) => <span key={transport} className="text-red-400" title={transport} aria-label={transport}><TransportIcon transport={transport} /></span>)}
          </div>
